...
if RequiredScript == "lib/managers/menumanager" then
	if MutatorRationing and TMP_mutator_saving.data and TMP_mutator_saving.data.MutatorRationing then
		Announcer:AddHostMod("Rationing, Enemies no longer drop ammo. Bulldozers have a chance to drop an ammo bag where they die.")
	end
end
