...
if RequiredScript == "lib/managers/menumanager" then
	if MutatorHardlineBreakout and TMP_mutator_saving.data and TMP_mutator_saving.data.MutatorHardlineBreakout then
		Announcer:AddHostMod("Hardline Breakout, Random bomb from nowhere")
	end
end
